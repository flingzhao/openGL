...
int main()
{
	...
	Shader myshader(std::string("../Assets/shaders/CubesShader.glsl"));
	glm::vec3 greencolor = {0.1f, 0.8f, 0.1f};
	myshader.Use();
	myshader.SetUniform4f("ourColor", greencolor);

	glm::mat4 view = camera.GetViewMatrix();
    myshader.SetMat4("ViewMat", view);
	glm::mat4 projection = glm::perspective(glm::radians(45.0f), 800.0f / 600.0f, 0.1f, 100.0f);
    myshader.SetMat4("ProjectionMat", projection);
	...
	while(!glfwWindowShouldClose(window))  
	{
		...
		myshader.SetUniform1I("texture0", 0);
		// myshader.SetUniform1I("texture1", 1);
		glBindVertexArray(VAO);
		...
		for(unsigned int i = 0; i < 10; ++i)
		{
            ...
            myshader.SetMat4("ModelMat", model);
