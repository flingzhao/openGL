...
int main()
{
    ...
    Shader simpleDepthShader("../../../Assets/shaders/shadow_mapping_depth.glsl");
    Shader debugDepthQuad("../../../Assets/shaders/debug_quad.glsl");
    Shader shader("../../../Assets/shaders/shadow_mapping.glsl");
