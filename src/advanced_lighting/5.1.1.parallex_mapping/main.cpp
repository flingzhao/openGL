...
unsigned int myloadTexture(char const * path)
{
...
int main()
{
    ...
    unsigned int heightMap = myloadTexture("../../../Assets/textures/bricks2_disp.jpg");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        shader.SetFloat("heightScale", heightScale); // adjust with X and Z keys
