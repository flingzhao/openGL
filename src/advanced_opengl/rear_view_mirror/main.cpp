...
int main()
{
    ...
    // -------------------------
    Shader shader("../../../Assets/shaders/rear_view_mirror.glsl");
    Shader screenShader("../../../Assets/shaders/rear_view_mirror_screen.glsl");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        camera.setCameraYaw(180.0f + camera.GetCameraYaw());
        glm::mat4 view = camera.GetViewMatrix();
        camera.setCameraYaw(camera.GetCameraYaw() - 180.0f);
