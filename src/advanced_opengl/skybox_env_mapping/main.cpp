...
int main()
{
    ...
    Shader shader("../../../Assets/shaders/skybox_env_mapping_obj.glsl");
    Shader skyboxshader("../../../Assets/shaders/skybox.glsl");
    Shader modelShader(std::string("../../../Assets/shaders/modelShader_env_mapping.glsl"));
    ...
    modelShader.SetInt("skybox", 12);
    // modelShader.SetInt("cube", 12);

    shader.Use();
    glActiveTexture(GL_TEXTURE11);
    glBindTexture(GL_TEXTURE_2D, cubeTexture);
    shader.SetInt("cube", 11);
